...
export const metadata: Metadata = {
  ...
  description:
    "Quer alugar seu imóvel em Curitiba? Preencha o cadastro online e um corretor da FYMOOB entra em contato pra agendar a visita de avaliação. CRECI J 9420.",
  alternates: {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-2 sm:px-6 lg:px-8">
      ...
      <div className="mt-6">
        ...
        <AnuncieWizard defaultOperacao="locacao" />
      </div>
